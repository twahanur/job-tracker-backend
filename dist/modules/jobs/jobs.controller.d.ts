...
export declare class JobsController {
    ...
    extractJobPreview(userId: string, dto: ExtractJobDto): Promise<{
        message: string;
        data: {
            extractedData: import("../ai/gemini.service").ExtractedJobData;
            rawContent: string;
            contentHash: string;
    ...
    getJobs(userId: string, query: FilterJobsDto): Promise<{
        message: string;
        data: {
            jobs: ({
                application: {
    ...
    getJobDetails(userId: string, jobId: string): Promise<{
        message: string;
        data: {
            application: ({
                selectedCv: {
    ...
    updateJob(userId: string, jobId: string, dto: Partial<CreateJobDto>): Promise<{
        message: string;
        data: {
            application: ({
                selectedCv: {
